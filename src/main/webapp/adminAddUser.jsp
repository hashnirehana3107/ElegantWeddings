        ...
        <div class="payment-form">
            <form action="createUser" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="mobile" name="mobile" placeholder="Enter the Mobile" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select" id="userRole" name="userRole" required>
                        ...
                        <option value="4">Customer Support Agent</option>
                    </select>
                </div>

                <div class="button-group">
                    <button type="submit" class="create-btn">Create a User</button>
                </div>
